...
public interface IExcelService {
    ...
    default <T, R> SXSSFWorkbook insertBigDataToWorkbook(SXSSFWorkbook workbook, Class<R> classConfig,
                                                         DataStream<List<T>> dataStream, Function<T, R> mapper) {
        return this.insertBigDataToWorkbook(workbook, classConfig, dataStream, mapper, null, null);
    }

    default <T, R> SXSSFWorkbook insertBigDataToWorkbook(SXSSFWorkbook workbook, Class<R> classConfig,
                                                         DataStream<List<T>> dataStream, Function<T, R> mapper,
                                                         Map<String, String> context) {
        return this.insertBigDataToWorkbook(workbook, classConfig, dataStream, mapper, context, null);
    }

    <T, R> SXSSFWorkbook insertBigDataToWorkbook(SXSSFWorkbook workbook, Class<R> classConfig,
                                                 DataStream<List<T>> dataStream, Function<T, R> mapper,
                                                 Map<String, String> context,
